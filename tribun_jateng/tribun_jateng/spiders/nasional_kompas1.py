...
class NasionalKompasSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://indeks.kompas.com/?site=food&date=2022-01-01'
    ...
    def parse_news_page(self, response):
        ...
        item['url'] = response.xpath('//div[@class="article__list__title"]/h3/a/@href').get()
        item['category'] = response.xpath('div[@class="article__list__info"]/div[@class="article__subtitle article__subtitle--inline"]/text()').get()
        # item['category'] = response.xpath('//div[@class="article__list__info"]/div[@class="article__subtitle article__subtitle--inline"]/text()').get()
