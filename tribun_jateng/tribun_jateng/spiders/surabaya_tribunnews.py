...
class TribunJatengSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://surabaya.tribunnews.com/index-news?date=2022-1-27',
        'https://surabaya.tribunnews.com/index-news?date=2022-2-27',
        'https://surabaya.tribunnews.com/index-news?date=2022-3-27',
        'https://surabaya.tribunnews.com/index-news?date=2022-4-27',
        'https://surabaya.tribunnews.com/index-news?date=2022-5-27',
        'https://surabaya.tribunnews.com/index-news?date=2022-6-27',
        'https://surabaya.tribunnews.com/index-news?date=2022-7-27',
        'https://surabaya.tribunnews.com/index-news?date=2022-8-27',
        'https://surabaya.tribunnews.com/index-news?date=2022-9-27',
        'https://surabaya.tribunnews.com/index-news?date=2022-10-27',
        'https://surabaya.tribunnews.com/index-news?date=2022-11-27',
        'https://surabaya.tribunnews.com/index-news?date=2022-12-27'
    ]
    ...
    def parse_news_page(self, response):
        ...
        content = response.xpath('//div[@class="side-article txt-article multi-fontsize"]//p//text()').getall()
        item['content']  = "".join(content)
        
        #item['category'] = response.xpath('//h2/a/text()').get()
